...
${OBJECTDIR}/src/Button.o: src/Button.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Button.o src/Button.cc

${OBJECTDIR}/src/engine/Entity.o: src/engine/Entity.cc 
	${MKDIR} -p ${OBJECTDIR}/src/engine
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/engine/Entity.o src/engine/Entity.cc

${OBJECTDIR}/src/engine/Timing.o: src/engine/Timing.cc 
	${MKDIR} -p ${OBJECTDIR}/src/engine
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/engine/Timing.o src/engine/Timing.cc
...
${OBJECTDIR}/src/graphics/Colours.o: src/graphics/Colours.cc 
	${MKDIR} -p ${OBJECTDIR}/src/graphics
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/graphics/Colours.o src/graphics/Colours.cc

${OBJECTDIR}/src/graphics/Graphics.o: src/graphics/Graphics.cc 
	${MKDIR} -p ${OBJECTDIR}/src/graphics
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/graphics/Graphics.o src/graphics/Graphics.cc

${OBJECTDIR}/src/graphics/Shaders.o: src/graphics/Shaders.cc 
	${MKDIR} -p ${OBJECTDIR}/src/graphics
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/graphics/Shaders.o src/graphics/Shaders.cc

${OBJECTDIR}/src/graphics/Texture.o: src/graphics/Texture.cc 
	${MKDIR} -p ${OBJECTDIR}/src/graphics
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/graphics/Texture.o src/graphics/Texture.cc

${OBJECTDIR}/src/main.o: src/main.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cc

${OBJECTDIR}/src/map/Map.o: src/map/Map.cc 
	${MKDIR} -p ${OBJECTDIR}/src/map
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/map/Map.o src/map/Map.cc

${OBJECTDIR}/src/map/PathFinder.o: src/map/PathFinder.cc 
	${MKDIR} -p ${OBJECTDIR}/src/map
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/map/PathFinder.o src/map/PathFinder.cc

${OBJECTDIR}/src/misc.o: src/misc.cc 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/misc.o src/misc.cc

${OBJECTDIR}/src/views/GameView.o: src/views/GameView.cc 
	${MKDIR} -p ${OBJECTDIR}/src/views
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/views/GameView.o src/views/GameView.cc

${OBJECTDIR}/src/views/MenuView.o: src/views/MenuView.cc 
	${MKDIR} -p ${OBJECTDIR}/src/views
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/views/MenuView.o src/views/MenuView.cc
